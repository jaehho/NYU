# main.py
from budgie_bot.audio_stream import AudioCapture
from budgie_bot.spectrogram import SpectrogramVisualizer
from budgie_bot.amplitude import AmplitudeVisualizer
import numpy as np
